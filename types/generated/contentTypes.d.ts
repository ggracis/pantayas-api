...
export interface ApiLocalLocal extends Schema.CollectionType {
  ...
  attributes: {
    ...
    pantallas: Attribute.Relation<
      'api::local.local',
      'oneToMany',
      'api::pantalla.pantalla'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiPantallaPantalla extends Schema.CollectionType {
  collectionName: 'pantallas';
  info: {
    singularName: 'pantalla';
    pluralName: 'pantallas';
...
export interface ApiProductoProducto extends Schema.CollectionType {
  ...
  attributes: {
    ...
    unidadMedida: Attribute.Enumeration<['Unidad', 'Kg.', 'Porci\u00F3n']> &
      Attribute.Required &
      Attribute.DefaultTo<'Unidad'>;
    precios: Attribute.JSON;
...
declare module '@strapi/strapi' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::pantalla.pantalla': ApiPantallaPantalla;
